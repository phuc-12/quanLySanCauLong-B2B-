						...
						<div class="wrapper">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<h3 class="listing-title">
										<a href="venue-details.html">NG Sports Academy</a>
									</h3>
									<div class="listing-details-group">
						...
						<div class="wrapper">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<h3 class="listing-title">
										<a href="venue-details.html">Rivan Badminton Academy</a>
									</h3>
									<div class="listing-details-group">
						...
						<div class="wrapper">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<h3 class="listing-title">
										<a href="venue-details.html">Russ Badminton</a>
									</h3>
									<div class="listing-details-group">
						...
						<div class="wrapper">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<h3 class="listing-title">
										<a href="venue-details.html">Andy’s Sports Academy</a>
									</h3>
									<div class="listing-details-group">
						...
						<div class="wrapper">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<h3 class="listing-title">
										<a href="venue-details.html">Herique Badminton</a>
									</h3>
									<div class="listing-details-group">
						...
						<div class="wrapper">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<h3 class="listing-title">
										<a href="venue-details.html">AG Sports</a>
									</h3>
									<div class="listing-details-group">
		...
		<footer class="footer">
			<div class="container">
				...
				<div class="footer-join">
					...
					<a href="register.html" class="btn btn-primary"><i class="feather-user-plus"></i> Tham Gia Cùng Chúng Tôi</a>
				</div>
				<!-- /Footer Join -->

...
<!-- Mirrored from dreamsports.dreamstechnologies.com/html/coaches-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Apr 2025 04:29:46 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
	...
	<div class="main-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="coaches-grid.html">Coaches Grid</a></li>
		...
		<section class="breadcrumb breadcrumb-list mb-0">
			...
			<div class="container">
				<h1 class="text-white">Coaches Grid Without Sidebar</h1>
				<ul>
					<li><a href="index.html">Home</a></li>
					<li>Coaches Grid</li>
				</ul>
										...
										<div class="sortby-filter-group">
											<div class="grid-listview">
												<ul class="nav">
													...
													<li>
														<a href="coaches-grid.html" class="active">
						...
						<div class="featured-venues-item">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<div class="listing-details-group">
										<p>Passionate Badminton Coach unlocking players' potential through strategic gameplay and strategies.</p>
									</div>
									<div class="coach-btn">
										<ul>
											<li>
						...
						<div class="featured-venues-item">
							<div class="listing-item listing-item-grid">										
								...
								<div class="listing-content">
									...
									<div class="listing-details-group">
										<p>Badminton coach with a passion for improving players' abilities and tactics the game.</p>
									</div>
									<div class="coach-btn">
										<ul>
											<li>
									...
									<div class="avalbity-review">
										<ul>
											...
											<li>
												<div class="list-reviews mb-0">							
													<div class="d-flex align-items-center">
														<span class="rating-bg">4.5</span><span>414 Reviews</span> 
													</div>
												</div>
											</li>
										</ul>
							...
							<div class="footer-widget footer-menu">
								...
								<div class="footer-address-blk">
									...
									<div class="footer-call">
										...
										<p><a href="https://dreamsports.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="482c3a2d29253b38273a3c3b082d30292538242d662b2725">[email&#160;protected]</a></p>
									</div>
								</div>
	...
	<!-- jQuery -->
	<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="37868d4da000c889627885c8-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="37868d4da000c889627885c8-text/javascript"></script>

	<!-- Select JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="37868d4da000c889627885c8-text/javascript"></script>

	<!-- Bootstrap DateTime Picker -->
	<script src="assets/js/moment.min.js" type="37868d4da000c889627885c8-text/javascript"></script>
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="37868d4da000c889627885c8-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="37868d4da000c889627885c8-text/javascript"></script>

<script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="37868d4da000c889627885c8-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"92a5cd28ba131065","version":"2025.3.0","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									<li class="active"><a href="user-dashboard.html">User Dashboard</a></li>
									...
									<li>
										<div class="appointment-item">
											<div class="appointment-img">
												<img src="assets/img/booking/booking-01.jpg" alt="Appointment">
											</div>
												...
												<tr>
													<td>
														<div class="academy-info academy-info">
															...
															<div class="academy-content">
																<h6><a data-bs-toggle="modal" data-bs-target="#upcoming-court">Leap Sports Academy</a></h6>
																<ul>
																	<li>Court 1</li>
						...
						<div class="card dashboard-card academy-card">
							<div class="card-header card-header-info">
								...
								<div class="card-header-btns">
									<nav>
										<div class="nav nav-tabs" role="tablist">
										  <button class="nav-link active" id="nav-Favourites-tab" data-bs-toggle="tab" data-bs-target="#nav-Favourites" type="button" role="tab" aria-controls="nav-Favourites" aria-selected="true">Court</button>
										  <button class="nav-link" id="nav-FavouritesCoaching-tab" data-bs-toggle="tab" data-bs-target="#nav-FavouritesCoaching" type="button" role="tab" aria-controls="nav-FavouritesCoaching" aria-selected="false">Coaching</button>
										</div>
									  </nav>
								</div>
							</div>
							<div class="tab-content">
								<div class="tab-pane fade show active" id="nav-Favourites" role="tabpanel" aria-labelledby="nav-Favourites-tab"
									tabindex="0">
									<div class="table-responsive dashboard-table-responsive">
										<table class="table dashboard-card-table">
											<tbody>
												<tr>
													<td>
														<div class="academy-info academy-info">
															...
															<div class="academy-content">
																<h6><a href="user-bookings.html">Wing Sports Academy</a></h6>
																<p>10 Bookings</p>
															</div>
														</div>
													</td>
												...
												<tr>
													<td>
														<div class="academy-info academy-info">
															...
															<div class="academy-content">
																<h6><a href="user-bookings.html">Feather Badminton</a></h6>
																<p>20 Bookings</p>
															</div>
														</div>
													</td>
												...
												<tr>
													<td>
														<div class="academy-info academy-info">
															...
															<div class="academy-content">
																<h6><a href="user-bookings.html">Bwing Sports Academy</a></h6>
																<p>30 Bookings</p>
															</div>
														</div>
													</td>
												...
												<tr>
													<td>
														<div class="academy-info academy-info">
															...
															<div class="academy-content">
																<h6><a href="user-bookings.html">Kevin Anderson</a></h6>
																<p>10 Bookings</p>
															</div>
														</div>
													</td>
												...
												<tr>
													<td>
														<div class="academy-info academy-info">
															...
															<div class="academy-content">
																<h6><a href="user-bookings.html">Angela Roudrigez</a></h6>
																<p>20 Bookings</p>
															</div>
														</div>
													</td>
												...
												<tr>
													<td>
														<div class="academy-info academy-info">
															...
															<div class="academy-content">
																<h6><a href="user-bookings.html">Evon Raddick</a></h6>
																<p>30 Bookings</p>
															</div>
														</div>
													</td>
											...
											<tbody>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-court" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/booking/booking-03.jpg" alt="Booking">
															</a>
															<span class="table-head-name flex-grow-1">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-court" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/booking/booking-04.jpg" alt="Booking">
															</a>
															<span class="table-head-name flex-grow-1">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-court" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/booking/booking-05.jpg" alt="Booking">
															</a>
															<span class="table-head-name flex-grow-1">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-court" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/booking/booking-06.jpg" alt="Booking">
															</a>
															<span class="table-head-name flex-grow-1">
											...
											<tbody>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-coach" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/featured/featured-05.jpg" alt="Venue">
															</a>
															<span class="table-head-name flex-grow-1">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-coach" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/featured/featured-06.jpg" alt="Venue">
															</a>
															<span class="table-head-name flex-grow-1">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-coach" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/featured/featured-07.jpg" alt="Venue">
															</a>
															<span class="table-head-name flex-grow-1">
													...
													<td>
														<div class="dropdown dropdown-action">
															<a href="#" data-bs-target="#upcoming-coach" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis"></i></a>
															<div class="dropdown-menu dropdown-menu-end">
																<a class="dropdown-item" href="javascript:void(0);">
																	<i class="feather-download"></i> Download 
																</a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" data-bs-toggle="modal" data-bs-target="#upcoming-coach" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/featured/featured-08.jpg" alt="Venue">
															</a>
															<span class="table-head-name flex-grow-1">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="user-invoice.html" class="avatar avatar-sm flex-shrink-0">
																<img class="avatar-img" src="assets/img/featured/featured-09.jpg" alt="Venue">
															</a>
															<span class="table-head-name flex-grow-1">

...
<!-- Mirrored from dreamsports.dreamstechnologies.com/html/coaches-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Apr 2025 04:29:47 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
	...
	<div class="main-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="coaches-list.html">Coaches List</a></li>
		...
		<section class="breadcrumb breadcrumb-list mb-0">
			...
			<div class="container">
				<h1 class="text-white">Coaches List Without Sidebar</h1>
				<ul>
					<li><a href="index.html">Home</a></li>
					<li >Coaches List</li>
				</ul>
			...
			<div class="container">
				...
				<div class="row">
							...
							<div class="listing-item listing-item-grid coach-listview">										
								...
								<div class="listing-content">
									<div class="list-reviews near-review near-review-list">							
										...
										<span class="mile-away"><span>From</span> $250 <span>/hr</span></span>
									</div>
						...
						<div class="featured-venues-item">
							<div class="listing-item listing-item-grid coach-listview">										
								...
								<div class="listing-content">
									<div class="list-reviews near-review near-review-list">							
										<div class="d-flex align-items-center">
											<span class="rating-bg">4.2</span><span>80 Reviews</span> 
										</div>
										<span class="mile-away"><span>From</span> $120 <span>/hr</span></span>
									</div>
									<h3 class="listing-title">
									...
									<div class="listing-details-group">
										<p>Experienced coach dedicated to enhancing your badminton skills and unlocking your full potential.</p>
									</div>
									<div class="avalbity-review avalbity-review-list">
										<ul>
											<li>
					...
					<div class="col-lg-12">
						<div class="featured-venues-item">
							<div class="listing-item listing-item-grid coach-listview">										
								<div class="listing-img">
									<a href="coach-detail.html">
										<img src="assets/img/featured/featured-07.jpg" alt="Venue">
									</a>
									<div class="fav-item-venues">
										<span class="tag tag-blue">Professional</span>	
										<div class="list-reviews coche-star">
								...
								<div class="listing-content">
									<div class="list-reviews near-review near-review-list">							
										...
										<span class="mile-away"><span>From</span> $750 <span>/hr</span></span>
									</div>
									<h3 class="listing-title">
							...
							<div class="listing-item listing-item-grid coach-listview">										
								...
								<div class="listing-content">
									<div class="list-reviews near-review near-review-list">							
										...
										<span class="mile-away"><span>From</span> $550 <span>/hr</span></span>
									</div>
									<h3 class="listing-title">
									...
									<div class="listing-details-group">
										<p>Experienced Coach passionate about elevating players' skills and fostering a love for the game.</p>
									</div>
									<div class="avalbity-review avalbity-review-list">
										<ul>
											<li>
					...
					<div class="col-lg-12">
						<div class="featured-venues-item">
							<div class="listing-item listing-item-grid coach-listview">										
								<div class="listing-img">
									<a href="coach-detail.html">
										<img src="assets/img/featured/featured-10.jpg" alt="Venue">
									</a>
									<div class="fav-item-venues">
										<span class="tag tag-blue">Intermediate</span>	
										<div class="list-reviews coche-star">
								...
								<div class="listing-content">
									<div class="list-reviews near-review near-review-list">							
										...
										<span class="mile-away"><span>From</span> $350 <span>/hr</span></span>
									</div>
									<h3 class="listing-title">
										<a href="coach-detail.html">Victor Newman</a>
									</h3>
									<ul class="mb-2">
										<li>
											<span>
												<i class="feather-map-pin me-2"></i>Sacramento, CA
											</span>
										</li>
									</ul>
									<div class="listing-details-group">
										<p>Badminton coach with a passion for improving players' abilities and tactics.</p>
									</div>
									<div class="avalbity-review avalbity-review-list">
										<ul>
											<li>
										...
										<ul class="profile-coache-list">
											<li>
												<a href="#" class="btn btn-primary w-100"><i class="feather-eye me-2"></i> View Profile</a>
											</li>
											<li>
												<a href="#" class="btn btn-secondary w-100"><i class="feather-calendar me-2"></i> Book Now</a>
											</li>
										</ul>
									</div>
								</div>
						...
						<div class="featured-venues-item">
							<div class="listing-item listing-item-grid coach-listview">										
								...
								<div class="listing-content">
									...
									<div class="listing-details-group">
										<p>Dedicated badminton expert meticulously perfecting techniques for best results</p>
									</div>
									<div class="avalbity-review avalbity-review-list">
										<ul>
											<li>
							...
							<div class="listing-item listing-item-grid coach-listview">										
								...
								<div class="listing-content">
									<div class="list-reviews near-review near-review-list">							
										...
										<span class="mile-away"><span>From</span> $180 <span>/hr</span></span>
									</div>
									<h3 class="listing-title">
							...
							<div class="listing-item listing-item-grid coach-listview">										
								...
								<div class="listing-content">
									<div class="list-reviews near-review near-review-list">							
										...
										<span class="mile-away"><span>From</span> $150 <span>/hr</span></span>
									</div>
									<h3 class="listing-title">
					...
					<div class="col-12 text-center mt-3">
						<a href="javascript:;" class="btn btn-load">Load More Coaches <img src="assets/img/icons/u_plus-square.svg" class="ms-2" alt="Icon"></a>
					</div>
				</div>
			</div>
							...
							<div class="footer-widget footer-menu">
								...
								<div class="footer-address-blk">
									...
									<div class="footer-call">
										...
										<p><a href="https://dreamsports.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9afee8fffbf7e9eaf5e8eee9daffe2fbf7eaf6ffb4f9f5f7">[email&#160;protected]</a></p>
									</div>
								</div>
	...
	<!-- jQuery -->
	<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="3e226f30644f98fe8571d509-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="3e226f30644f98fe8571d509-text/javascript"></script>

	<!-- Select JS -->
	<script src="assets/plugins/select2/js/select2.min.js" type="3e226f30644f98fe8571d509-text/javascript"></script>

	<!-- Bootstrap DateTime Picker -->
	<script src="assets/js/moment.min.js" type="3e226f30644f98fe8571d509-text/javascript"></script>
	<script src="assets/js/bootstrap-datetimepicker.min.js" type="3e226f30644f98fe8571d509-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="3e226f30644f98fe8571d509-text/javascript"></script>

<script src="../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3e226f30644f98fe8571d509-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"92a5cd2c9efb1a5b","version":"2025.3.0","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

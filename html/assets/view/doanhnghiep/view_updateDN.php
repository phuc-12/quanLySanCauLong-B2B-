                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="assets/view/admin/requirement.php?id=<?php echo $layid ?>">
                                        <i class="fa-regular fa-rectangle-list" style="font-size: 29px;"></i>
                        ...
                        <table style="margin:0; height: 500px;" style="width: 50%; float:left;">
                            ...
                            <tr>
                                <td colspan=2 style="text-align:right;">
                                    ...
                                    <a href="../../../business-dashboard.php?id=<?php echo $layid ?>" style="padding: 10px 0;height: 45px; width: 120px; background-color: #097E52; color: white; 
                                ...
                                case 'Cập Nhật':
                                {
                                    ...
                                    if($maDN!='')
                                    {
                                        if($k->themxoasua("UPDATE doanhnghiep SET tenDN = '$tenDN',diaChi = '$diaChi',soDienThoai = '$soDienThoai',email = '$email'  WHERE maDN = '$maDN' LIMIT 1")==1)
                                        {
                                            ...
                                            window.location="../admin/business.php?id='.$maDN.'";	
                                            </script>';
                                        }
                                        echo'<script language="javascript">
